...
Visual resources for planning and production.

| Folder | Purpose |
|---|---|
| `generated/` | AI-generated concept sheets and candidate sprites |
| `reference/` | Gameplay mockups, style references, and source visual references |

Use this folder for art direction and production notes. Final game-ready exports should be copied to `public/assets/`.
